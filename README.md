...
Why this application? I wrote it because code signing requires a completely different approach for each file type. The result is this program: It combines all possible approaches within a single tool.
